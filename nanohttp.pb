...
DeclareModule nanoHTTP
  ...
  Declare ParseHTTPContent(ContentString.s, Map TargetMap.s())
EndDeclareModule
...
; -----------------------------------------------------------------------------------------;
  Procedure.b StartServer(*HTTPport)
 ;============================================================================================ Variables, Structs, Zip-Map
    ...
    Define.s ContentType, CurrentHeaderLine, HTTPHeaderString, TempString, RouteHash, ContentString, DPath
    BufferStep = 10000
    BufferLen = 0
    ReceivedBytes = 0
    ...
    DPath = GetCurrentDirectory() + "app.zip"
;============================================================================================ Prepare Zip-Archive
    UseZipPacker()
...
;============================================================================================ Init Server
    If CreateNetworkServer(#NHTTP_SERVER_HANDLE, *HTTPport, #PB_Network_TCP,nanoHTTP::IPMask)
      Repeat
...
ThreadID = CreateThread(nanoHTTP::@StartServer(),HTTPPort)
